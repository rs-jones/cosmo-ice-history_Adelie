...
%
% cp=comppars1026_mod(physpars,samppars,scalefactors,maxdepth)
%
...
%
function cp=comppars1026_mod(pp,sp1026,sf1026,maxdepth)
%
...
if sp1026.concentration10 > 0
    ...
    consts_10.Natoms = pp.Natoms10;
    consts_10.sigma190 = pp.sigma190_10;
    % consts_10.delsigma190 = pp.delsigma190_10; % not used
    consts_10.sigma0 = pp.sigma010;
    consts_10.k_neg = pp.k_neg10;
    % consts_10.k_negpartial = pp.k_negpartial10;
    % consts_10.fstar = pp.fstar10;
    ...
    z = cp.depthvector;
    for i = 1:length(z)
        cp.P_total10(i) = P_mu_total_alpha1(z(i), sf1026.P, consts_10); % Balco's muon model
    end
...
if sp1026.concentration26 > 0
    ...
    consts_26.Natoms = pp.Natoms26;
    consts_26.sigma190 = pp.sigma190_26;
    % consts_26.delsigma190 = pp.delsigma190_26; % not used
    consts_26.sigma0 = pp.sigma026;
    consts_26.k_neg = pp.k_neg26;
    % consts_26.k_negpartial = pp.k_negpartial26;
    % consts_26.fstar = pp.fstar26;
    ...
    z = cp.depthvector;
    for i = 1:length(z)
        cp.P_total26(i) = P_mu_total_alpha1(z(i), sf1026.P, consts_26); % Balco's muon model
    end
